...
for(k in c(5,10,15)){
  corrplot::corrplot(abs(cor(ZMOFA[[paste0("k",k)]])))
  corrplot::corrplot(abs(cor(ZiClust[[paste0("k",k)]])))
  corrplot::corrplot(abs(cor(ZiClust[[paste0("k",k)]], ZMOFA[[paste0("k",k)]])))
}
```


#Variance Explained plot
Function to get R2 plot for iCluster: calculateVarianceExplained4iClust
```{r, echo=F}
