...
for (n in nsamples_downsampled) {
  ...
  for (i in 1:ntrials) {
    ...
    if (file.exists(incompleteD_incompleteM_file)) {
    ...
    if (file.exists(incompleteD_completeM_file)) {
    ...
    # if (file.exists(completeD_incompleteM_file)) {
    ...
    # if (file.exists(completeD_completeM_file)) {
    ...
    if (file.exists(imputed_incomplete_file)) {
    ...
    # if (file.exists(imputed_complete_file)) {
