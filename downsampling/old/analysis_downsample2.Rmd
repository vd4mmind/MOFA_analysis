...
in.folder <- "/hps/nobackup/stegle/users/ricard/downsample/results2/mRNA"

nsamples_downsampled <- seq(0,75,5)
ntrials <- 25
```
...
tmp[,c("complete_ngenesets","incomplete_ngenesets"):=0]
...
pdf("/Users/ricard/CLL/downsample/out/genesets2.pdf", width = 7, height = 4.5)
print(p)
dev.off()
```
...
# pdf("/Users/ricard/CLL/downsample/out/imputation.pdf", width = 7, height = 4.5)
pdf("/homes/ricard/CLL/downsample/out/survival2.pdf", width = 7, height = 4.5)
print(p)
dev.off()
```
