...
# Calculate variance explained per view for iCluster
```{r, echo=F}
...
# save
gg_legend <- grid.arrange(ggplot(),get_legend(gg_truth), get_legend(gg_MOFA+ guides(fill=guide_legend(bquote(R^2)))),ggplot(), ncol=1, heights=c(1.5,1,1,1.5))
