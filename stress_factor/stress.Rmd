...
#make plot
pdf("/Users/ricard/MOFA_CLL/stress_factor/out/beesawrm.pdf", width = 5, height = 5, useDingbats=F)
par(mar=c(2.3, 4.5, 4, 2), xpd=TRUE)
bs <- beeswarm(df$x, pwcol = MCcolors, pch = 16,
          ylab = "Factor 5", xlab = "",
          cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
legend("top", legend =  levels(MC)[1:3], title = "Stress levels", pch = 16, col = col4MC[1:3], ncol = 4,
