...
---
# Introduction
This script analyses the first Factor, which is linked to IGHV status, as shown in Figure 3. Further, it performs imputation of IGHV status based on this factor.
