...
# plot top weights
# pdf(file.path(plotdir,"mRNAweigths_IGHV.pdf"),width=5.6, height=4.8, useDingbats = FALSE)
...
# heatmap
# pdf(file.path(plotdir,"heatmap_mRNA_MC_rotated2.pdf"),width=7, height=4.8, onefile = F)
...
# plot top weights
# pdf(file.path(plotdir,"Methweigths_IGHV.pdf"),width=5.6, height=4.8, useDingbats = FALSE)
...
topSites <- names(sort(abs(model@Expectations$SW$Methylation$E[,idx_ighv]), decreasing = T))[1:ntop_meth]
...
# heatmap
# pdf(file.path(plotdir,"heatmap_meth.pdf"),width=7, height=4.8, onefile = F)
...
# Make plot
# pdf(file.path(plotdir,"drugweigths_IGHV.pdf"),width=7, height=4, useDingbats=F)
