...
survivalData<- survivalDataTTT[!is.na(survivalDataTTT[,1]),]
...
# TTT
ggplot(df_survival, aes(x=predictor,y=coef,ymin=lower,ymax=higher))+
...
```{r, fig.height=12, fig.width=12}
 ...
 # joint plot of significant factors:
  pdf(file.path(plotdir, "KaplanMeier_signif.pdf"), width=10.5, height=3.5)
