...
# I/O
```{r}
source("../CLL_Analysis/plottingUtils.R")
...
# arrange all plots
library(cowplot)
plot_grid(gg_summary_random, gg_summary_full, gg_legend_sum, ncol=3, rel_widths = c(10,10,3), labels=c("a","b",""))#, top=textGrob("Imputation of drug response",gp=gpar(fontsize=15,font=1)))
```
