...
```{r}
out_mofa <- "/Users/bvelten/Documents/MOFA/GFA_imputation_models/CLL/imputation/fullCases/mofa/"
out_gfa <- "/Users/bvelten/Documents/MOFA/GFA_imputation_models/CLL/imputation/fullCases/gfa/"
...
names(ListGFA) <- gsub(".rds", "",paste0("N",GFAfiles[grepl(".rds",GFAfiles)]))
...
save(benchmark_results, file=file.path(outdir,"imputation_full_drug_k10.RData"))
```
